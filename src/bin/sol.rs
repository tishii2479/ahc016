...
fn main() {
    ...
    const CONSTRUCT_ITER_COUNT: usize = 1000000;
    const SIMILARITY_ITER_COUNT: usize = 1000;
    ...
    let state = create_optimal_graphs(n, m, CONSTRUCT_ITER_COUNT);
